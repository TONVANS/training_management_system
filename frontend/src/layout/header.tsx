    ...
    <header className="h-16 bg-white border-b border-gray-200/80 flex items-center justify-between px-4 lg:px-8 sticky top-0 z-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
      ...
      <div className="flex items-center gap-3 lg:gap-5">
        ...
        <div className="relative" ref={menuRef}>
          ...
          {/* Dropdown Content */}
          {isMenuOpen && (
            <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.08)] border border-gray-100 py-2 z-10 animate-in fade-in slide-in-from-top-2 duration-200">
